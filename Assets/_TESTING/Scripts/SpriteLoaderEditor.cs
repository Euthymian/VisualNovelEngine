...
public class SpriteLoaderEditor : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        if (characterConfigFile != null && characterConfigFile.characterConfigDatas != null && characterConfigFile.characterConfigDatas.Length > 0)
        {
            string[] characterNames = GetCharacterNames(characterConfigFile.characterConfigDatas);
    ...
    {
        if (characterConfigFile != null && characterConfigFile.characterConfigDatas != null && selectedCharacterIndex < characterConfigFile.characterConfigDatas.Length)
        {
            string characterName = characterConfigFile.characterConfigDatas[selectedCharacterIndex].name;
