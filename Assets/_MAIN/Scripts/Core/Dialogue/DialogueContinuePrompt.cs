...
namespace DIALOGUE
{
    public class DialogueContinuePrompt : MonoBehaviour
    {
        ...
        public bool isShowing => anim.gameObject.activeSelf; //activeSelf is true if the anim is locally active, even if its parent is inactive
        ...
        public void Show()
        {
            ...
            float characterWidth = finalCharacter.pointSize;
