...
public class CanvasGroupController
{
    ...
    public Coroutine Show(float speedMultiplier = 1, bool immediate = false)
    {
        ...
        co_showing = DialogueSystem.Instance.StartCoroutine(Fading(1f, speedMultiplier, immediate));
        return co_showing;
    }
    ...
    public Coroutine Hide(float speedMultiplier = 1, bool immediate = false)
    {
        ...
        co_hiding = DialogueSystem.Instance.StartCoroutine(Fading(0f, speedMultiplier, immediate));
        return co_hiding;
    }
